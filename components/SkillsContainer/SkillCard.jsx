...
export default function SkillCard({info}) {
  return (
    <section className='bg-gradient-to-b from-blue-600 to-violet-600 p-[2px] w-[150px] h-[200px] lg:w-[200px] lg:h-[250px] rounded-xl hover:scale-105 transition duration-300 ease-in-out'>
